...
(1, 'Pertee', 'productimg/pertedupoids.png', 'Fitbox vous offre un service de restauration et de personnalisation des repas: des repas pour un jour, une semaine ou un mois,préparation des plats personnalisés,personnalisez votre propre régime avec les choses que vous aimez et faites-le livrer à votre porte.'),
(2, 'Gain', 'productimg/gaindupoids.png', 'Fitbox vous offre un service de restauration et de personnalisation des repas: des repas pour un jour, une semaine ou un mois,préparation des plats personnalisés,personnalisez votre propre régime avec les choses que vous aimez et faites-le livrer à votre porte.\r\n'),
(3, 'Mantien', 'productimg/mantiendupoids.png', 'Fitbox vous offre un service de restauration et de personnalisation des repas: des repas pour un jour, une semaine ou un mois,préparation des plats personnalisés,personnalisez votre propre régime avec les choses que vous aimez et faites-le livrer à votre porte.\r\n');
