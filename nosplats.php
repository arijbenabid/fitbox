                ...
                <nav class="navbar navbar-expand-sm ">
                    ...
                    <div class="collapse navbar-collapse" id="menu">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                <a href="" class="nav-link">NOS PLATS</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="card-group col-lg-3 col-md-6 col-sm-12 mb-5 ">
                    <form method="POST" action="nosplats.php?action=add&id=<?php echo $ligne2['id_plat'] ?>">
                        <div class="card">
                            ...
                            <img class="card-img-top get_id" src="<?php echo $ligne2['imgp'] ?>" alt="Card image cap" data-toggle='modal' data-target='#modalContactForm<?php echo $ligne2['id_plat'] ?>'>
                            <div class="card-body">
